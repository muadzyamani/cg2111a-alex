...
def parseUserInput(input_str:str, exitFlag:Event = _EXIT_EVENT):
    ...
    if command == "w":
        ...
        commandType = TCommandType.COMMAND_CLOSE_CLAW
        params = parseParams(split_input[1:], 0, None)
        return  (packetType, commandType,  params)
    elif command == "k":
        commandType = TCommandType.COMMAND_OPEN_DISPENSER
        params = parseParams(split_input[1:], 0, None)
        return  (packetType, commandType,  params)
    elif command == "l":
        ...
        commandType = TCommandType.COMMAND_SET_MOVINGTIME
        params = parseParams(split_input[1:], 1, "Enter new moving time.\n")
        return  (packetType, commandType,  params)
    elif command == "q":
